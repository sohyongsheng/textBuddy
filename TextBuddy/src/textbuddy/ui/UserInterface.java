...
/**
 * Implements the user interface for TextBuddy. This class essentially bridges
 * the gap between the machinery handling task operations, that is the
 * <code>Task Manager</code> class, as well as the machinery handling log files,
 * that is the <code>LogFileManager</code> class
 *
...
public class UserInterface {
    ...
    /**
     * Constructor for this class. Also gets the name for the log file.
     * 
     * @param logFileName
