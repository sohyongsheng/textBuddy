...
public class CommandTest {
	...
	public void testCommand() {		
		...
		assertTrue("displayCommand's action did not parse correctly", displayCommand.commandAction.equals(displayAction));
		...
		assertTrue("addCommand's action did not parse correctly", addCommand.commandAction.equals(addAction));
		assertTrue("addCommand's parameter did not parse correctly", addCommand.commandParameter.equals(testDescription));
	}
